...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Nervous but curious 🌋', // 作者简介
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/QiLOL', // 你的github个人主页 例如 https://github.com/tangly1024
